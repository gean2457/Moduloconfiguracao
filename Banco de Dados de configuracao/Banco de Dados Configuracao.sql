USE [master]
GO
/****** Object:  Database [Configuracao]    Script Date: 16/03/2023 13:58:46 ******/
...
USE [Configuracao]
GO
/****** Object:  Table [dbo].[GrupoUsuario]    Script Date: 16/03/2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Permissao]    Script Date: 16/03/2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PermissaoGrupoUsuario]    Script Date: 16/03/2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 16/03/2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UsuarioGrupoUsuario]    Script Date: 16/03/2023 13:58:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[PermissaoGrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_PermissaoGrupoUsuario_GrupoUsuario] FOREIGN KEY([IdPermissao])
...
GO
ALTER TABLE [dbo].[UsuarioGrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_UsuarioGrupoUsuario_GrupoUsuario] FOREIGN KEY([IdUsuario])
REFERENCES [dbo].[GrupoUsuario] ([Id])
GO
